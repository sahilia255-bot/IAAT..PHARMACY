...
def products():
    ...
    <div class="page">
      ...
      <input class="search" id="search" type="search" oninput="searchProduct()" placeholder="Search product or brand...">
...
function searchProduct() {
    ...
    cards.forEach(card => {
        ...
        const searchableText = normalizeText(
            productName + " " + brandName + " " + allCardText
        );

        card.style.display =
            searchableText.includes(value) ? "" : "none";
    });
}
</script>
""")
...
def contact():
    ...
    ">
        ...
        ">
            ...
            <!-- WHATSAPP BUTTON -->
            <a href="https://wa.me/+96176188827"
               target="_blank"
               style="
                   display:inline-flex;
                   align-items:center;
